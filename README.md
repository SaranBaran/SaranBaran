### `C:\SaryaBaran> whoami /full` 🍵

**Sarya Baran Kılıç** — [`SaranBaran`](https://github.com/SaranBaran)

Brown University · **B.S. Computer Science** + **B.A. Comparative Literature** · Class of 2028
...
### `> tasklist /research` — Active Projects
...
| [Tech as Prosthetics](https://github.com/brown-cntr/Tech-as-Prosthetics.git)| Fullstack developer for Tech as Prosthetic website workshop project | `RUNNING` |
...
| game | jam | role |
|------|-----|------|
| [Star Crossed Lovers](https://yahay.itch.io/star-crossed-lovers) | Frost Jam | Unity Dev |
| [Voxham Central](https://saranbaran.itch.io/voxham-central) | Global Game Jam | Unity Dev |
| [Little Boy Commits War Crimes Against Nature](https://yahay.itch.io/lbcwan) | Ludum Dare 48 | Unity Dev |
...
[![Schedule a Meeting](https://img.shields.io/badge/Schedule_a_Meeting-00A2FF?style=flat-square&logo=calendly&logoColor=white)](https://calendly.com/sarya_kilic-brown/new-meeting)
```
